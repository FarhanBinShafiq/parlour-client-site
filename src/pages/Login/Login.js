...
const Login = () => {
    ...
    return (
        <div>
            ...
            <div className="  min-h-screen flex items-center pl-3 pr-3 ">
                <div className="w-full">
                    ...
                    <div className="bg-black p-10 rounded-lg shadow md:w-3/4 mx-auto lg:w-1/2">
                        ...
                        <br />
                        <p className='text-info'>If are a new user ? <Link to="/signup" className='text-teal-600 bg-black uppercase '>Create Account</Link> </p>
